        ...
        <div class="dashboard-body">
            ...
            <div class="dashboard-body__content p-4">
                ...
                <div class="card common-card admin-table-card">
                    <div class="card-body">
                        <h5 class="mb-3">Projets a valider</h5>
                        <form method="GET" action="<?= ROOT ?>/Admins/pending_projects" class="row gy-3 mb-4">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-1">
                                <select name="sort_by" class="common-input common-input--bg">
                                    ...
                                    <option value="category" <?= $projectSortBy === 'category' ? 'selected' : '' ?>>Cat.</option>
                                    <option value="status" <?= $projectSortBy === 'status' ? 'selected' : '' ?>>Statut</option>
                                </select>
                            </div>
                            <div class="col-md-1">
                                ...
                                <tbody>
                                    <?php if (!empty($projects)): ?>
                                        <?php foreach ($projects as $project): ?>
                                            ...
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" class="pending-project-checkbox" name="project_ids[]" value="<?= (int)($project->id ?? 0) ?>"></td>
