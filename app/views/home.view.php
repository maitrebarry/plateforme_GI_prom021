...
<body class="public-site um6p-site">
    ...
    <main class="change-gradient ai-home um6p-home">
        ...
        <style>
            /* Import Boxicons fallback CDN just in case */
            @import url('https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css');

            /* Fluid Container Layout */
            .um6p-home .container,
            .um6p-home .container-two {
            ...
            .um6p-site .header {
                ...
                border-bottom: 1px solid rgba(23, 21, 18, 0.08) !important;
                box-shadow: 0 10px 40px -25px rgba(23, 21, 18, 0.25) !important;
            ...
            .um6p-site .nav-menu__link:hover {
            ...
            .um6p-home .hero {
                padding: clamp(30px, 5vw, 60px) 0 35px !important;
            }

            /* Fluid Salon Hero Grid */
            .um6p-home .salon-grid {
            ...
            .um6p-home .mini-card {
                ...
                border: 1px solid rgba(189, 74, 31, 0.08) !important;
                box-shadow: 0 15px 45px -30px rgba(23, 21, 18, 0.15), 0 4px 12px -8px rgba(23, 21, 18, 0.05) !important;
            ...
            .um6p-home .news-card:hover {
                ...
                border-color: rgba(189, 74, 31, 0.25) !important;
                box-shadow: 0 30px 65px -25px rgba(189, 74, 31, 0.18), 0 15px 30px -15px rgba(18, 60, 52, 0.08) !important;
            }

            .um6p-home .salon-hero-card {
                min-height: 580px !important;
                padding: clamp(30px, 4.5vw, 65px) !important;
                background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(255, 250, 244, 0.95)) !important;
            ...
            .um6p-home .salon-hero-card::before {
                content: "";
                position: absolute;
                top: -50%;
                left: -50%;
                width: 200%;
                height: 200%;
                background: radial-gradient(circle, rgba(189, 74, 31, 0.04) 0%, transparent 60%);
                pointer-events: none;
                z-index: 0;
            }
            ...
            .um6p-home .hero-chip {
                color: #bd4a1f !important;
                background: rgba(189, 74, 31, 0.09) !important;
                border-radius: 999px !important;
                padding: 8px 16px !important;
                letter-spacing: .08em !important;
                font-weight: 850 !important;
                border: 1px solid rgba(189, 74, 31, 0.15) !important;
                width: fit-content;
                display: inline-flex;
                align-items: center;
                gap: 8px;
            ...
            /* Lead text design & Reveal animations */
            .um6p-home .salon-lead {
                color: #171512 !important;
            ...
            .um6p-home .salon-lead .lead-line {
                ...
                animation: public-title-reveal 0.9s cubic-bezier(0.16, 1, 0.3, 1) forwards;
            }

            .um6p-home .salon-lead .lead-line:nth-child(2) {
                animation-delay: 0.15s;
            }

            .um6p-home .salon-lead .lead-line:nth-child(3) {
            ...
            .um6p-home .salon-lead .lead-line--accent::after {
                content: "";
                position: absolute;
                left: 0;
                right: 0;
                bottom: 0.05em;
                height: 0.16em;
                background: rgba(189, 74, 31, 0.18);
                z-index: -1;
                border-radius: 999px;
                transform: scaleX(0);
                transform-origin: left;
                animation: public-underline 0.8s cubic-bezier(0.16, 1, 0.3, 1) 0.7s forwards;
            }
            ...
            .um6p-home .hero-btn {
                background: linear-gradient(135deg, #bd4a1f, #9c350f) !important;
                border: none !important;
                color: #ffffff !important;
                box-shadow: 0 10px 25px -10px rgba(189, 74, 31, 0.45) !important;
            }

            .um6p-home .hero-btn:hover {
                transform: translateY(-4px) scale(1.02) !important;
                box-shadow: 0 15px 30px -8px rgba(189, 74, 31, 0.6) !important;
                color: #ffffff !important;
            }

            .um6p-home .hero-btn-outline {
                background: #ffffff !important;
                border: 2px solid #e3d8cc !important;
                color: #171512 !important;
                box-shadow: 0 10px 25px -15px rgba(23, 21, 18, 0.1) !important;
            }

            .um6p-home .hero-btn-outline:hover {
                background: #fffaf7 !important;
                border-color: #bd4a1f !important;
                color: #bd4a1f !important;
                transform: translateY(-4px) scale(1.02) !important;
                box-shadow: 0 15px 30px -10px rgba(189, 74, 31, 0.25) !important;
            }
            ...
            /* Stats Blocks (Fluid and Spacious) */
            .um6p-home .salon-proof {
                display: grid !important;
            ...
            .um6p-home .salon-proof__item {
                ...
                box-shadow: 0 10px 25px -20px rgba(23, 21, 18, 0.1) !important;
                text-align: center;
            }

            .um6p-home .salon-proof__item:hover {
                transform: translateY(-5px) !important;
                border-color: rgba(189, 74, 31, 0.3) !important;
                background: #ffffff !important;
                box-shadow: 0 20px 40px -25px rgba(189, 74, 31, 0.25) !important;
            }
            ...
            .um6p-home .salon-proof__item span {
                color: #67615a !important;
                font-size: 0.92rem;
                font-weight: 600;
                display: block;
            ...
            .um6p-home .salon-side {
                ...
                position: relative;
                overflow: hidden;
                box-shadow: 0 25px 55px -25px rgba(18, 60, 52, 0.4) !important;
                border: 1px solid rgba(255, 255, 255, 0.1) !important;
            }

            .um6p-home .um6p-campus-frame img {
                border-radius: 24px !important;
                transition: transform 10s ease, filter 0.5s ease !important;
            }

            .um6p-home .salon-side:hover .um6p-campus-frame img {
            ...
            .um6p-home .um6p-campus-caption {
                ...
                background: rgba(18, 60, 52, 0.88) !important;
                backdrop-filter: blur(12px);
                padding: 24px !important;
                box-shadow: 0 15px 35px -10px rgba(12, 40, 35, 0.5) !important;
                z-index: 5;
            }
            ...
            /* Underline decoration on section heads */
            .um6p-home .section-head h2::after {
                content: "";
                position: absolute;
                left: 0;
                bottom: 0;
            ...
            .um6p-home .top-liked-shell:hover .section-head h2::after,
            .um6p-home .ai-launcher:hover .section-head h2::after,
            .um6p-home .filters:hover .section-head h2::after {
                width: 100px;
            }
            ...
            .um6p-home .project-title a:hover,
            .um6p-home .publication-title a:hover {
                color: #bd4a1f !important;
            }

            /* Tech Pills and Categories styling */
            .um6p-home .project-category,
            .um6p-home .project-stat,
            .um6p-home .tech-pill,
            .um6p-home .badge-pill,
            ...
            .um6p-home .ai-chip {
                ...
                border: 1px solid #f3e6da !important;
                font-weight: 800 !important;
            ...
            .um6p-home .project-category {
                ...
                border-color: rgba(189, 74, 31, 0.15) !important;
            }

            .um6p-home .project-image-count {
                border-radius: 999px !important;
                background: rgba(18, 60, 52, 0.85) !important;
                color: #ffffff !important;
                backdrop-filter: blur(8px);
            ...
            .um6p-home .tech-pill:hover,
            .um6p-home .ai-chip:hover {
            ...
            .um6p-home .project-link i {
                transition: transform 0.3s ease;
            }

            .um6p-home .project-link:hover {
                color: #9c350f !important;
            }

            .um6p-home .project-link:hover i {
            ...
            .um6p-home .ai-input {
                border-radius: 14px !important;
                border: 1.5px solid #eaded3 !important;
            ...
            .um6p-home .filters .form-control:focus,
            .um6p-home .filters .form-select:focus,
            .um6p-home .ai-input:focus {
                border-color: #bd4a1f !important;
                box-shadow: 0 0 0 4px rgba(189, 74, 31, 0.12) !important;
            ...
            .um6p-home .page-nav:hover:not(:disabled) {
                background: #bd4a1f !important;
                color: #ffffff !important;
                border-color: transparent !important;
                transform: translateY(-2px);
                box-shadow: 0 10px 20px -8px rgba(189, 74, 31, 0.5) !important;
            }
            ...
            .um6p-home .ai-launcher {
                background: linear-gradient(135deg, #ffffff, #fffdfb) !important;
            }

            /* Reveal on scroll transition - FIXED */
            .um6p-home .reveal-item {
                opacity: 0 !important;
                transform: translateY(35px) scale(0.985) !important;
                transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1),
                    opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) !important;
            }

            .um6p-home .reveal-item.is-visible {
                opacity: 1 !important;
